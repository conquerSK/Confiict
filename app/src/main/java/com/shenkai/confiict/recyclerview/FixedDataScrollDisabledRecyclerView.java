package com.shenkai.confiict.recyclerview;
...
import com.shenkai.confiict.view.RecyclerAdapter;
...
public class FixedDataScrollDisabledRecyclerView extends RecyclerView {
    public FixedDataScrollDisabledRecyclerView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init();
    }
